...
class BedrockLLMService:
    ...
    def __init__(self, region: str, access_key: str, secret_key: str, model_id: str = None):
        ...
        # Use Claude Sonnet 4.5 - Update with your working model ID
        # Default: anthropic.claude-sonnet-4-5-20250929-v1:0
        # If you have a working inference profile or provisioned model, pass it as model_id parameter
